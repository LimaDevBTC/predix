/**
 * Script para deploy do predixv2 na testnet Stacks
 *
 * Uso: ORACLE_MNEMONIC="..." node scripts/deploy-predixv2.mjs
 */
...
if (!MNEMONIC) {
  ...
  console.error('Usage: ORACLE_MNEMONIC="..." node scripts/deploy-predixv2.mjs')
  process.exit(1)
}

const CONTRACT_NAME = 'predixv2'
const CONTRACT_PATH = './contracts/predixv2.clar'
...
async function main() {
  console.log('Deploying predixv2 to Stacks testnet...\n')
